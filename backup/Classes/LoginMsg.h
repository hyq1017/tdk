...
class Login : public ::google::protobuf::MessageLite {
 ...
 private:
  ...
  #else
  friend void  protobuf_AddDesc_LoginMsg_2eproto();
  #endif
...
inline const ::std::string& Login::friends(int index) const {
  return friends_.Get(index);
}
inline ::std::string* Login::mutable_friends(int index) {
  return friends_.Mutable(index);
}
inline void Login::set_friends(int index, const ::std::string& value) {
  friends_.Mutable(index)->assign(value);
}
inline void Login::set_friends(int index, const char* value) {
  friends_.Mutable(index)->assign(value);
}
inline void Login::set_friends(int index, const char* value, size_t size) {
  friends_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
}
inline ::std::string* Login::add_friends() {
  return friends_.Add();
}
inline void Login::add_friends(const ::std::string& value) {
  friends_.Add()->assign(value);
}
inline void Login::add_friends(const char* value) {
  friends_.Add()->assign(value);
}
inline void Login::add_friends(const char* value, size_t size) {
